...
- [부록 A. g1 AnimalScript](appendices/g1_animalscript.md)
- [부록 B. g2 AnimalScript](appendices/g2_animalscript.md)
...
AnimalScript 원문은 제출 문서에서 확인하기 쉽도록 Markdown 부록 파일로도 분리했다.

- `appendices/g1_animalscript.md`
- `appendices/g2_animalscript.md`
...
AnimalScript 원문은 별도 Markdown 파일에 정리했다.
